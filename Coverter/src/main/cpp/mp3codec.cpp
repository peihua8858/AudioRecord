...
Java_linc_com_peihua_converter_PCMDecoder_init(JNIEnv *env, jclass type, jstring pcmFilePath_,
...
Java_linc_com_peihua_converter_PCMDecoder_encode(JNIEnv *env, jclass type) {

    encoder->Encode();

}extern "C"
JNIEXPORT void JNICALL
Java_linc_com_peihua_converter_PCMDecoder_destroy(JNIEnv *env, jclass type) {
